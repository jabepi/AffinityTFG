...
long psets_size = 2621440000; //1000 veces el tamaño de la L3
...
class Thread_array{
	...
	public: 
		...
		//TODO Funciones para pruebas
		// void prueba1(){
		// 	(*shared_vec)[0] = '2';
		// 	(*priv_vec)[0] = '3';
		// }
		// void prueba2(){
		// 	cout << "Compartido: " <<(*shared_vec)[0] << endl << "Privado: " << (*priv_vec)[0] << endl;
		// }
};	
...
int main(int argc, char* argv[]){
	...
	cout << "T_lectura/escritura: " << rw_tmarks[0] << endl << endl;

	cout << "Resultado hilo 2:" << endl;
	cout << "T_lectura: " << r_tmarks[1] << endl;
	cout << "T_escritura: " << w_tmarks[1] << endl;
	cout << "T_lectura/escritura: " << rw_tmarks[1] << endl;
